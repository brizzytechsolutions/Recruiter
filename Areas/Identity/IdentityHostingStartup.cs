...
[assembly: HostingStartup(typeof(Recruiter.Areas.Identity.IdentityHostingStartup))]
namespace Recruiter.Areas.Identity
{
    public class IdentityHostingStartup : IHostingStartup
    {
        public void Configure(IWebHostBuilder builder)
        {
            builder.ConfigureServices((context, services) => {
                services.AddDbContext<AuthRecruiterContext>(options =>
